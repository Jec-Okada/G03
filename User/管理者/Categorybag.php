...
<body>
    ...
    <tr>
      <td>
        ...
        <tr>
            <td class=""> <a id="detail" href="CategoryDetail.html">1(リンクになる予定)</a></td>
            <td>さっぱり系</td>
        </tr>
        <tr >
            <td class="">2</td>
    ...
    <button onclick="location.href='CategoryBagAdd.html'" type="button">追加画面へ</button>
    <button onclick="location.href='adminmenu.html'" type="button">戻る</button></a>
</div>
</div>   
