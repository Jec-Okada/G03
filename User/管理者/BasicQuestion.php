            ...
            <div class="offcanvas offcanvas-start  text-bg-success" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle active" href="BasicQuestion.html" id="navberDropdownMenuLink"role="button" data-bs-toggle="dropdown"aria-haspopup="true"aria-expanded="false">ベーシック質問一覧</a>
                            <div class="dropdown-menu" aria-labelledby="navberDropdownMenuLink">
...
<table border="1" class="table table-bordered">
    ...
    <tr>
        <td><a id="detail" href="BasicQuestionChange.html">5(リンクになる予定)</a></td>
        <td>麺食べたいの？</td>
        <td>1</td>
        <td>10</td>
        <td>1</td>
...
<button onclick="location.href='BasicQuestionAdd.html'" type="button">追加画面へ</button>
