...
<body>
            ...
            <div class="offcanvas offcanvas-start  text-bg-success" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle active" href="Categorybag.html" id="navberDropdownMenuLink"role="button" data-bs-toggle="dropdown"aria-haspopup="true"aria-expanded="false">カテゴリ袋一覧</a>
                            <div class="dropdown-menu" aria-labelledby="navberDropdownMenuLink">
    ...
    <div id="Bagname">
        <label for="text">袋の名前を入力してください</label>
        <input type=”text” id="Inputtext" class="Bagname" >

    </div> 
    <div id="b">
        <input type="button" name="CategoryBagAdd" id="Add" value="カテゴリー袋追加" />
    </div>
</div> 
    <div id="b">
        <button onclick="location.href='Categorybag.html'" type="button">戻る</button></a>
    </div>
